...
I uses https://api.frankfurter.app/currencies api for the currency name and https://api.frankfurter.app/latest?amount=${amount}&from=${fromCurrency}&to=${toCurrency} this api for converting one currency to other currency. 

uses native stack for navigation
